...
namespace App\Livewire\W4LaravelKit\PowerGrid\Fonts;

use PowerComponents\LivewirePowerGrid\Themes\DaisyUI;

class PowerGridFont1 extends DaisyUI
{
    ...
    public function footer(): array
    {
        return [
            ...
            'select' => 'select flex rounded-md py-1.5 px-4 pr-7 w-auto text-base-content',
            'footer' => 'border-x border-b rounded-b-lg border-b border-t border-base-300 text-neutral-content',
            'footer_with_pagination' => 'md:flex md:flex-row w-full items-center py-3 overflow-y-auto pl-2 pr-2 relative bg-neutral text-neutral-content',
        ];
    }
    ...
    {
        return [
            'div' => 'select-none flex items-center gap-1 !text-neutral-content',
        ];
    }
    ...
    {
        return [
            'th' => 'px-6 py-3 text-left text-xs font-medium tracking-wider checkbox-info',
            'base' => '',
